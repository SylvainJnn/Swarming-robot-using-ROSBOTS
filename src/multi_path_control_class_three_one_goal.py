...
class multi_goal_path_planning:
    def __init__(self):
        ...
        self.client3 = actionlib.SimpleActionClient('rosbot3/move_base', MoveBaseAction)
    ...
    def main_loop(self): #define the functionality of the main loop, which will run continuously until the node is shut down
        while not self.ctrl_c:
            ...
            self.client3.send_goal(self.Goal3, feedback_cb=self.feedback_callback3)
    ...
    def create_goal(self):
        ...
        self.Goal2.target_pose.pose.position.y = 2
        ...
        self.Goal3.target_pose.pose.position.x = 2
        self.Goal3.target_pose.pose.position.y = 2
        self.Goal3.target_pose.pose.position.z = 0
        self.Goal3.target_pose.pose.orientation.x = 0
        self.Goal3.target_pose.pose.orientation.y = 0
        self.Goal3.target_pose.pose.orientation.z = 0
    ...
    def next_goal3(self):
        print('=== NEXT GOAL3 ===')
        self.Goal3.target_pose.pose.position.x -=0.5
        self.Goal3.target_pose.pose.position.y = 0.625
        self.client3.send_goal(self.Goal3, feedback_cb=self.feedback_callback3)
        #self.client3.wait_for_result()
    ...
    def feedback_callback3(self, feedback3):
        feedback3 = self.client3.get_state()
        if feedback3 != 3:
            print('[Rosbot3] State: %d, going to goal..'%(feedback3))
            print('====================================')
        else:
            print('[Rosbot3] State: %d, reached the goal!'%(feedback3))
            print('====================================')
            #self.next_goal3()
